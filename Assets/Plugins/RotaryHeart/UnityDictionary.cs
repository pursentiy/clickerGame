...
using Plugins.RotaryHeart.References;
using UnityEngine;

namespace Plugins.RotaryHeart
{
    /// <summary>
    ...
    [System.Serializable]
    public class UnityDictionary<TKey, TValue> : DrawableDictionary, IDictionary<TKey, TValue>, UnityEngine.ISerializationCallbackReceiver
    {
