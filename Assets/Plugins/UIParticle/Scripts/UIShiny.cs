...
using Plugins.UIParticle.Scripts.Common;
...
namespace Coffee.UIExtensions
{
	...
	public class UIShiny : UIEffectBase
	{
		...
		//################################
		public const string shaderNameDefault = "UI/Hidden/UI-Effect-Shiny";
        public const string shaderNameSoftMask = "UI/Hidden/UI-Effect-Shiny-SoftMask";
        ...
        [Tooltip("Use SoftMask compatible material.")]
        [SerializeField] protected bool m_UseSoftMask;
		...
		[Obsolete][HideInInspector]
		[SerializeField][Range(0, 100)] float m_LoopDelay = 1;
		[Obsolete][HideInInspector]
		...
		/// Initial play delay.
		/// </summary>
		public float initialPlayDelay { get { return _player.initialPlayDelay; } set { _player.initialPlayDelay = value; } }
		...
		protected override Material GetMaterial()
		{
			...
			var shaderName = (m_UseSoftMask ? shaderNameSoftMask : shaderNameDefault);
