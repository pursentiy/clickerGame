...
namespace RSG
{
    ...
    public class Promise<TPromisedT> : IPromise<TPromisedT>, IPendingPromise<TPromisedT>, IPromiseInfo
    {
        ...
        public Promise(object owner = null)
        {
            ...
            if (Promise.TrackPromisesName && owner != null)
            {
                Name = owner.GetType().Name;
            }
        }

        public Promise(Action<Action<TPromisedT>, Action<Exception>> resolver, object owner = null)
        {
            CurState = PromiseState.Pending;
            _id = Promise.NextId();
        ...
        public IPromise CatchAsResolved(Action<Exception> onRejected)
        {
            ...
            Action<Exception> rejectHandler = ex =>
            {
                ...
                {
                    EventsReceiver.OnHandlerException(cbEx, onRejected, Name);
