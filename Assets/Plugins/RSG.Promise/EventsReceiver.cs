...
namespace Plugins.RSG.Promise
{
    public static class EventsReceiver
    {
        ...
        public static void OnHandlerException(Exception exception, Delegate a, string debugInfo)
        {
            Receiver?.OnHandlerException(exception, a, debugInfo);
        }
    }
    ...
    public interface IEventsReceiver
    {
        ...
        void OnHandlerException(Exception exception, Delegate a, string debugInfo);
    }
    ...
    public class DefaultEventsReceiver : IEventsReceiver
    {
        ...
        public void OnHandlerException(Exception exception, Delegate a, string debugInfo)
        {
